    ...
    override fun onBindViewHolder(p0: FavouriteViewHolder, p1: Int) {
        ...
        p0.btnFavourite.setOnClickListener(View.OnClickListener {
            if (!DBAsynTask(context, restaurantEntity, 1).execute().get()) {
                ...
                val result=
                    DBAsynTask(context, restaurantEntity, 2).execute().get()
                ...
                val result=
                    DBAsynTask(context, restaurantEntity, 3).execute().get()
        ...
        p0.llcontent.setOnClickListener(View.OnClickListener {

            println(p0.txtResturantkName.getTag().toString())

            val intent = Intent(context, RestaurantMenuActivity::class.java)

            intent.putExtra("restaurantId", p0.txtResturantkName.getTag().toString())
        ...
        val checkFav=
            DBAsynTask(context, restaurantEntity, 1).execute()
